...
namespace sotec_pos
{
    ...
    {
        int secili_urun_id, adisyon_id;
        decimal secili_miktar;
        public pos_masa_sicak_satis(int secili_urun_id, int adisyon_id, decimal secili_miktar)
        {
        ...
        {
            DataTable dt = SQL.get("INSERT INTO adisyon_kalem (adisyon_id, urun_id, miktar, kaydeden_kullanici_id) VALUES (" + adisyon_id + ", " + secili_urun_id + ", " + secili_miktar.ToString().Replace(',', '.') + ", " + SQL.kullanici_id + "); SELECT SCOPE_IDENTITY();");
